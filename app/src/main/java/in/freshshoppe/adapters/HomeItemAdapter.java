...
public class HomeItemAdapter extends RecyclerView.Adapter<HomeItemAdapter.ProgramViewHolder> {
    ...
    @NonNull
    @Override
    public HomeItemAdapter.ProgramViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View view = inflater.inflate(R.layout.restaurant_item_layout, viewGroup, false);

        return new HomeItemAdapter.ProgramViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final HomeItemAdapter.ProgramViewHolder programViewHolder, final int i) {
