...
import in.freshshoppe.activities.Combos;
...
public class ComboListAdapter extends RecyclerView.Adapter<ComboListAdapter.ProgramViewHolder> {
    ...
    @NonNull
    @Override
    public ComboListAdapter.ProgramViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
        View view = inflater.inflate(R.layout.combolist_layout, viewGroup, false);

        return new ComboListAdapter.ProgramViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ComboListAdapter.ProgramViewHolder programViewHolder, final int i) {
...
//        ct=String.valueOf(favouritesBeanSampleList.size());
            ...
            Combos.itemcounter.setText(Constants.cartitems);
