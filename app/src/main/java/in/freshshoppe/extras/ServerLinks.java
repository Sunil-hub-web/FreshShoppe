package in.freshshoppe.extras;

public class ServerLinks {

//    public static String main_url =  "http://rawonlinemarketing.co.in/admin/api/api.php?";
    public static String main_url =  "https://www.freshshoppe.in/admin/api/api.php?";
    ...
    public static String combolist_url =  main_url+"method=allCombos";
